...
export const experienceData: Experience[] = [
  ...
  },
  {
    ...
    position: "Researcher",
    description:
      "Proposed Fastpath method, to improve efficiency of GNNs. Applied to VisionGNN, achieving significant latency reduction on ImageNet and CIFAR-10 while preserving accuracy. <em>Under review at WSDM 2026</em>.",
    location: "Bhubaneswar, India",
  },
  {
